...
\item \textbf{干净口径的证据表征消融（探索性结论）}：统一 BMC 判据下三种设置 BMC 回归通过率均达 100\%；定位精度 A 64.7\% > D 56.9\% > B 55.9\% > C 43.2\%（95/102），A 与 C 差异显著（McNemar p=0.0004，Holm 校正 p=0.0024），其余五对均不显著——证据表征的定位优势被模型与数据卫生强烈调节，而非固有属性；成本 B 最低（0.40 vs A 0.60 美元）。

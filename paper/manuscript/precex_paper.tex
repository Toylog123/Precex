...
\begin{table}[!t]
\centering
\caption{跨模型主实验对比（MiniMax M3 vs DeepSeek v4-flash，seed 0 严格配对，n=34 每设置，3-seed 全量验证见正文；修复率按 BMC 判据）}

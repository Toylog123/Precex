// PreCex - counter_alu L2 缺陷样本 l2_cnt_04（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『边界回绕』类缺陷——计数器提前回绕：cnt==8 时强制归 0（正常应连续计数到 255 才回绕，击穿 A1）
// 来源：rtl/counter_alu/counter_alu.sv 单点注入（行 39）| 击穿断言：counter_alu A1（仅使能自增 1）

// PreCex - fifo_sync L2 缺陷样本 l2_fifo_01（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『握手』类缺陷——空时仍读：can_rd 去掉 !empty 门控（空时读出无效数据，击穿 A2）
// 来源：rtl/fifo_sync/fifo_sync.sv 单点注入（行 31）| 击穿断言：fifo_sync A2（空时不读）

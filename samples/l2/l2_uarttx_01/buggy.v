// PreCex - uart_tx L2 缺陷样本 l2_uarttx_01（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『握手』类缺陷——起始位握手失效：删 S_IDLE 中『起始位立即输出低电平』（txd 保持高，击穿 uart A1 起始位为低）
// 来源：rtl/uart_tx/uart_tx.sv 单点注入（行 57）| 击穿断言：uart_tx A1（START 时 txd==0）

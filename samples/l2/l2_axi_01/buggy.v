// PreCex - axi_lite_slave L2 缺陷样本 l2_axi_01（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『边界回绕』类缺陷——axi 写地址译码偏移：AWADDR[ADDR_W-1:2] 改 [ADDR_W-2:1]（寄存器错位写，击穿 A7）
// 来源：rtl/axi_lite_slave/axi_lite_slave.sv 单点注入（行 100）| 击穿断言：axi A7（写数据生效）

// PreCex - counter_alu L2 缺陷样本 l2_cnt_03（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『复位』类缺陷——计数器复位值 0 改全 1（复位释放后 cnt 非 0，击穿 A3 复位归 0）
// 来源：rtl/counter_alu/counter_alu.sv 单点注入（行 37）| 击穿断言：counter_alu A3（复位释放归 0）

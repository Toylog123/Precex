// PreCex - fifo_sync L2 缺陷样本 l2_fifo_04（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『复位』类缺陷——读指针复位值 0 改全 1（head 越界，击穿 A3 指针不越界）
// 来源：rtl/fifo_sync/fifo_sync.sv 单点注入（行 40）| 击穿断言：fifo_sync A3（head<DEPTH）

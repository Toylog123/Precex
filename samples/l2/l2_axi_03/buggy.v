// PreCex - axi_lite_slave L2 缺陷样本 l2_axi_03（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『位宽截断』类缺陷——axi 寄存器位宽收窄 1 位（reg0-3 高位截断，击穿 A6/A7 读译码/写生效）
// 来源：rtl/axi_lite_slave/axi_lite_slave.sv 单点注入（行 43）| 击穿断言：axi A6/A7（读数据译码/写数据生效）

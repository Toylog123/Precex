// PreCex - counter_alu L2 缺陷样本 l2_cnt_01（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『状态跳转』类缺陷——counter ALU 运算译码对调：op==OP_ADD 输出改减法（加法变减法，击穿 A4）
// 来源：rtl/counter_alu/counter_alu.sv 单点注入（行 28）| 击穿断言：counter_alu A4（ALU 输出正确性）

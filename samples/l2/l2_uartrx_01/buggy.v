// PreCex - uart_rx L2 缺陷样本 l2_uartrx_01（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『状态跳转』类缺陷——uart_rx 跳过起始位中点确认：IDLE 检测到下降沿直接进 DATA（击穿 A1/A2）
// 来源：rtl/uart_rx/uart_rx.sv 单点注入（行 50）| 击穿断言：uart_rx A1/A2（起始位中点确认）

// PreCex - fsm_ctrl L3 缺陷样本 s33（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『复位』类缺陷——fsm 步进计数复位不清零：step_cnt 复位 6'd0 改 6'd1（空闲期计数非 0，击穿 A6）
// 来源：rtl/fsm_ctrl/fsm_ctrl.sv 单点注入（行 36）| 击穿断言：fsm_ctrl A6（空闲期 step_cnt 归 0）

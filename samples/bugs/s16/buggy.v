// PreCex - uart_tx L3 缺陷样本 s16（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『边沿』类缺陷——波特率脉冲取反：baud_tick 改 !baud_tick（位节奏错误）
// 来源：rtl/uart_tx/uart_tx.sv 单点注入（行 65）| 击穿断言：uart_tx 位周期性质

...
- 复现命令：`python3 scripts/bug_injector.py --module uart_rx --error-type state_trans --sample-id s36 --variant 5 --param CLK_FREQ=1600,BAUD=100`

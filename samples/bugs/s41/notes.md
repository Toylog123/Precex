...
- 复现命令：`python3 scripts/bug_injector.py --module uart_tx --error-type state_trans --sample-id s41 --variant 7 --param CLK_FREQ=800,BAUD=100 --natural-tb --min-fail-step 20`

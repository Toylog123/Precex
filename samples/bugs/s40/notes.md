...
- 复现命令：`python3 scripts/bug_injector.py --module fifo_sync --error-type fifo_full --sample-id s40 --variant 2 --param DEPTH=32 --natural-tb --min-fail-step 20 --tb-shallow`

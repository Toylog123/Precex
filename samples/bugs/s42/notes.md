...
- 复现命令：`python3 scripts/bug_injector.py --module fsm_ctrl --error-type boundary_wrap --sample-id s42 --variant 4 --param TIMEOUT=62 --natural-tb --min-fail-step 20 --tb-shallow`

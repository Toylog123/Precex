// PreCex - fifo_sync L3 缺陷样本 s22（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『复位』类缺陷——写指针复位值 0 改全 1（tail 越界，击穿 A3 复位归 0）
// 来源：rtl/fifo_sync/fifo_sync.sv 单点注入（行 41）| 击穿断言：fifo_sync A3（tail 复位归 0）

// PreCex - uart_rx L3 缺陷样本 s28（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『复位』类缺陷——uart_rx 复位后忙标志错误：复位时 rx_busy 改为 1（复位后误报忙，击穿 A5）
// 来源：rtl/uart_rx/uart_rx.sv 单点注入（行 44）| 击穿断言：uart_rx A5（忙标志与状态一致）

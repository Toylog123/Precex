// PreCex - axi_lite_slave L3 缺陷样本 s51（buggy 版）
// 作者：Toylog | 版本：v0.1 | 功能概述：注入『握手』类缺陷——BVALID 保持逻辑删除（不等 BREADY 就清零，握手保持态缺失 split_state）
// 来源：rtl/axi_lite_slave/axi_lite_slave.sv 单点注入（行 1）| 击穿断言：axi_lite A3（BVALID 保持至 BREADY）

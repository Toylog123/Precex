...
// [bug_injector] weak tb sanitized for boundary_wrap: stripped 8 fatal check(s) on cnt/count/dout/state/done/timeout_irq/txd/tx_busy/readback/WSTRB/RVALID/BVALID/reg/rx_data/rx_valid
